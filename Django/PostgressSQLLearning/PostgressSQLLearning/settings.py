"""
Django settings for PostgressSQLLearning project.
...
SECRET_KEY = 'django-insecure-%j@yvv9bu2i@@v#l_mmh)m7^w95ro$wc!%()e4k*!pph_34fmz'
...
ROOT_URLCONF = 'PostgressSQLLearning.urls'
...
WSGI_APPLICATION = 'PostgressSQLLearning.wsgi.application'
